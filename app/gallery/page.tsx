...
export const metadata: Metadata = {
  ...
  description:
    "Browse CureCraft Concrete projects across Dallas–Fort Worth: stamped patios, driveway replacements, pool decks, decorative concrete, and commercial flatwork.",
